...
async def _seed_demo_data() -> None:
    ...
    await db.users.insert_one({"_id": "user-admin", "name": "System Administrator", "email": "admin@libconnect.local", "password_hash": "$2b$12$6d9s8VQwTg1x8m7s5yH5P.r4/6kJ87nTxKeVhT6uX9n3P6g2p6o2", "role": "admin", "library_id": None, "phone": None, "avatar_url": None, "is_active": True, "created_at": now, "updated_at": now})
    await db.users.insert_one({"_id": "user-librarian", "name": "Maya Librarian", "email": "librarian@libconnect.local", "password_hash": "$2b$12$6d9s8VQwTg1x8m7s5yH5P.r4/6kJ87nTxKeVhT6uX9n3P6g2p6o2", "role": "librarian", "library_id": "library-001", "phone": None, "avatar_url": None, "is_active": True, "created_at": now, "updated_at": now})
    await db.users.insert_one({"_id": "user-student", "name": "Aarav Student", "email": "student@libconnect.local", "password_hash": "$2b$12$6d9s8VQwTg1x8m7s5yH5P.r4/6kJ87nTxKeVhT6uX9n3P6g2p6o2", "role": "student", "library_id": "library-001", "phone": None, "avatar_url": None, "is_active": True, "created_at": now, "updated_at": now})
